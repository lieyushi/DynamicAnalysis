...
public:
	...
	static const float W_poly6_scalar(const float& r, const float& radius);
    static const float W_spiky(const glm::vec3& r, const float& radius);
	static const float W_spiky_scalar(const float& dist, const float& radius);
	...
	static const float W_cubic_scalar(const float& r, const float& radius);
